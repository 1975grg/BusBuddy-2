...
function SortableRouteStopItem({ stop, index, control, onRemove, setValue, watch }: RouteStopItemProps) {
  ...
  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>, fieldOnChange: (value: string) => void) => {
    const value = e.target.value;
    fieldOnChange(value); // Update react-hook-form field
    setValue(`stops.${index}.name`, value); // Update form state
